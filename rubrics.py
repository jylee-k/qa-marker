RUBRICS = {
    "Helpfulness": {
        -2: "Not informative at all with very awkward phrasing and terrible quality.",
        -1: "Very little information with awkward phrasing and low quality.",
        0: "Somewhat informative with slightly awkward phrasing and acceptable quality.",
        1: "Informative with no awkward phrasing and decent quality.",
        2: "Very informative with very smooth phrasing and outstanding quality."
    },
    "Naturalness": {
        -2: "Very unnatural with choppy flow, incomplete ideas, and unclear meaning.",
        -1: "Somewhat unnatural with awkward flow, missing details, or noticeable clarity issues.",
        0: "Mostly natural but slightly rigid phrasing or minor missing elements.",
        1: "Natural, smooth, and complete with clear and coherent expression.",
        2: "Highly natural, very smooth, fully complete, and exceptionally clear to read."
    },
    "Completeness": {
    ...
    "Quality": {
        -2: "Poorly structured, hard to interpret, and overly wordy or rambling.",
        -1: "Weak structure with interpretability issues or excessive verbosity.",
        0: "Acceptable structure but somewhat wordy or occasionally unclear.",
        1: "Well-structured, interpretable, and adequately concise.",
        2: "Exceptionally well-structured, highly interpretable, and extremely concise without losing meaning."
    },
    "Interpretability": {
    ...
    "Informative": {
        -2: "Contains major inaccuracies or irrelevant information that misleads the reader.",
        -1: "Contains several inaccuracies and includes mostly irrelevant or low-value details.",
        0: "Generally accurate but includes minor mistakes or some unnecessary information.",
        1: "Accurate, relevant, and focused with only minimal irrelevant content.",
        2: "Highly accurate, extremely relevant, and fully focused with no unnecessary information."
    },
    "Accuracy": {
